...
if __name__ == '__main__':
    # Hyperparameters
    CONFIG_PATH = '/configs/S_WAE.yaml'
    ...
    # Prepare logger
    csv_logger = pl_loggers.CSVLogger(save_dir=config['CSVLogger_params']['save_dir'], name=config['CSVLogger_params']['name'])
    ...
    model_path = inspect.getfile(vae_models[config['model_params']['name']])
